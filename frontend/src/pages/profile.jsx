      ...
      <main className="flex flex-col flex-1 p-4 overflow-auto items-center">
        <div className="mt-5 flex flex-col items-center w-6/12 py-2 border-4 border-blue-400 rounded-lg">
          ...
          <div className="flex items-center mt-5 w-8/12">
            <label className="text-gray-600 w-1/3">氏名（漢字）</label>
            <input className="p-2 border-2 rounded-lg w-2/3 px-4" />
          </div>
          <div className="flex items-center mt-3 w-8/12">
            <label className="text-gray-600 w-1/3">氏名（カナ）</label>
            <input className="p-2 border-2 rounded-lg w-2/3 px-4" />
          </div>
          <div className="flex items-center mt-3 w-8/12">
          ...
          <div className="flex items-center mt-3 w-8/12">
            ...
            <label for="default-radio-1" class="ms-2 text-sm font-medium text-gray-900">男性</label>
            ...
            <label for="default-radio-2" class="ms-2 text-sm font-medium text-gray-900">女性</label>
          </div>
          <div className="flex items-center mt-3 w-8/12">
          ...
          <div className="flex items-center mt-3 w-8/12">
            <label className="text-gray-600 w-2/5">卒業予定</label>
